...
class BlazeFaceLandmark(BlazeLandmarkBase):
    """
    BlazeFaceLandmark performs facial landmark regression using a precompiled Hailo model.
    It receives a cropped/normalized ROI (e.g., from a face detector), 
    and outputs keypoint predicted positions.
    """
